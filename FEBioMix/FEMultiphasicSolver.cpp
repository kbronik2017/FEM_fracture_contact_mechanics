...
bool FEMultiphasicSolver::Quasin(double time)
{
	...
	// convergence norms
	double	normR1 = 0.0;		// residual norm
	double	normE1 = 0.0;		// energy norm
	double	normD = 0.0;		// displacement norm
	double	normd = 0.0;		// displacement increment norm
	double	normRi = 0.0;		// initial residual norm
	double	normEi = 0.0;		// initial energy norm
	double	normEm = 0.0;		// max energy norm
	double	normDi =0.0;		// initial displacement norm

	// poro convergence norms data
	double	normPi = 0.0;		// initial pressure norm
	double	normP = 0.0;		// current pressure norm
	double	normp = 0.0;		// incremement pressure norm
